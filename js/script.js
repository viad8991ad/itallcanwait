...
// img_weapon.setAttribute("src", "img/" + item.weapon.name + ".png")
//
// let img_artefact_1 = exampleModal.querySelector('.artefact-img-1');
// img_artefact_1.setAttribute("src", "img/" + item.artifact["1"].name + "_1.png")
//
// let img_artefact_2 = exampleModal.querySelector('.artefact-img-2');
// img_artefact_2.setAttribute("src", "img/" + item.artifact["2"].name + "_2.png")
//
// let img_artefact_3 = exampleModal.querySelector('.artefact-img-3');
// img_artefact_3.setAttribute("src", "img/" + item.artifact["3"].name + "_3.png")
//
// let img_artefact_4 = exampleModal.querySelector('.artefact-img-4');
// img_artefact_4.setAttribute("src", "img/" + item.artifact["4"].name + "_4.png")
//
// let img_artefact_5 = exampleModal.querySelector('.artefact-img-5');
// img_artefact_5.setAttribute("src", "img/" + item.artifact["5"].name + "_5.png")
